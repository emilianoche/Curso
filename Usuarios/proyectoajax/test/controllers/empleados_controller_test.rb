...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { apellido: @empleado.apellido, legajo: @empleado.legajo, nombre: @empleado.nombre }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { apellido: @empleado.apellido, legajo: @empleado.legajo, nombre: @empleado.nombre }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
